...
The steps of the import included loading the dataset using the read_csv function and the relative pathname. I also used skip = 1 because the first row in the csv file was a key or legend that described the time points in the dataset. Since this row was not data, I did not include it in my dataframe. I also changed the column name of baseline to t0 and the remaining time points so it followed an increase time for each column. 
...
There are a total of `r nrow(included_one) ` participants who appear in only the baseline or amyloid datasets. This includes participants with the following id: 14, 4, 268.
